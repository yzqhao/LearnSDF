...
LearSDFApp::LearSDFApp(HINSTANCE hInstance)
	: D3DApp(hInstance)
{
}

LearSDFApp::~LearSDFApp()
{
}

bool LearSDFApp::Initialize()
{
...
void LearSDFApp::OnMouseDown(WPARAM btnState, int x, int y)
{
	mLastMousePos.x = x;
	mLastMousePos.y = y;
...
void LearSDFApp::OnMouseUp(WPARAM btnState, int x, int y)
{
	ReleaseCapture();
}

void LearSDFApp::OnMouseMove(WPARAM btnState, int x, int y)
{
...
void LearSDFApp::Update(const GameTimer& gt)
{
...
void LearSDFApp::Draw(const GameTimer& gt)
{
...
// app define
//
void LearSDFApp::BuildBoxGeometry()
{
...
void LearSDFApp::BuildShadersAndInputLayout()
{
	HRESULT hr = S_OK;

    mvsByteCode = d3dUtil::CompileShader(L"LearnSDF\\color.hlsl", nullptr, "VS", "vs_5_0");
    mpsByteCode = d3dUtil::CompileShader(L"LearnSDF\\color.hlsl", nullptr, "PS", "ps_5_0");
...
void LearSDFApp::BuildDescriptorHeaps()
{
...
void LearSDFApp::BuildConstantBuffers()
{
...
void LearSDFApp::BuildRootSignature()
{
